...
public partial class BookStoreDbContext : IdentityDbContext<ApiUser>
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Authors__3214EC0776E92BF2");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Books__3214EC07C6C81D63");

            entity.HasIndex(e => e.Isbn, "UQ__Books__447D36EA0F323A7A").IsUnique();
